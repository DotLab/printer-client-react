...
import {LICENSE_CC_BY, LICENSE_CC_BY_SA, LICENSE_CC_BY_ND, LICENSE_CC_BY_NC, LICENSE_CC_BY_NC_SA, LICENSE_CC_BY_NC_ND, LICENSE_CC_PD, LICENSE_GNU_GPL, LICENSE_GNU_LGPL, LICENSE_BSD} from '../src/components/utils';
...
const dict = {
  'CC-BY': LICENSE_CC_BY,
  'CC-BY-SA': LICENSE_CC_BY_SA,
  'CC-BY-ND': LICENSE_CC_BY_ND,
  'CC-BY-NC': LICENSE_CC_BY_NC,
  'CC-BY-NC-SA': LICENSE_CC_BY_NC_SA,
  'CC-BY-NC-ND': LICENSE_CC_BY_NC_ND,
  'CC-PD': LICENSE_CC_PD,
  'GNU-GPL': LICENSE_GNU_GPL,
  'GNU-LGPL': LICENSE_GNU_LGPL,
  'BSD': LICENSE_BSD,
};
