export const TYPE_PRINTER = '3d';
export const TYPE_ART = 'Art';
export const TYPE_FASHION = 'Fashion';
export const TYPE_GADGETS = 'Gadgets';
export const TYPE_HOBBY = 'Hobby';
export const TYPE_HOUSEHOLD = 'Household';
...
const types = {
  '3d': [PRINTER_ACCESSORIES, PRINTER, PRINTER_EXTRUDERS, PRINTER_PARTS, PRINTER_TESTS],
  'Art': [ART_2D, ART_TOOLS, ART_BADES, ART_INTERACTIVE, ART_MATH, ART_SCAN, ART_SCULPTURES, ART_LOGO],
  'Fashion': [FASHION_ACCESSORIES, FASHION_BRACELETS, FASHION_COSTUME, FASHION_EARRINGS, FASHION_GLASSES,
    FASHION_JEWELRY, FASHION_KEYCHAINS, FASHION_RINGS],
  'Gadgets': [GADGETS_AUDIO, GADGETS_CAMERA, GADGETS_COMPUTER, GADGETS_MOBILE, GADGETS_TABLET, GADGETS_GAMES],
  'Hobby': [HOBBY_AUTO, HOBBY_DIY, HOBBY_ELECTRONICS, HOBBY_MUSIC, HOBBY_RC, HOBBY_ROBOTICS, HOBBY_SPORT],
  'Household': [HOUSEHOLD_BATHROOM, HOUSEHOLD_CONTAINERS, HOUSEHOLD_DECOR, HOUSEHOLD_DINING,
    HOUSEHOLD_SUPPLY, HOUSEHOLD_OFFICE, HOUSEHOLD_ORGANIZATION, HOUSEHOLD_OUTDOOR, HOUSEHOLD_PETS],
  'Learning': [LEARNING_BIO, LEARNING_ENG, LEARNING_MATH, LEARNING_PHYS],
  'Model': [MODEL_ANIMAL, MODEL_BUILDING, MODEL_CREATURES, MODEL_FOOD, MODEL_FURNITURE, MODEL_ROBOTS,
    MODEL_PEOPLE, MODEL_PROPS, MODEL_VEHICLES],
  'Game': [GAME_CHESS, GAME_DICE, GAME_MECH, GAME_PLAYSETS, GAME_PUZZLES, GAME_TOY],
};
