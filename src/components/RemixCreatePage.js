...
export default class RemixCreatePage extends React.Component {
  ...
  createRemix(e) {
    ...
    const {sourceThingId, sourceThingName, sourceThingUploaderId, sourceThingUploaderName,
      pictureBuffer, buffer, fileName, fileSize, name, license, category, type, summary, printerBrand,
  ...
  render() {
    const {subTypes, printingSettings, fileName, preview, sourceThingId,
      sourceThingName, sourceThingUploaderName, pictureName} = this.state;
